...
public class ItemSilverArmor {
    ...
    public void onLivingHurt(LivingHurtEvent event) {
        if (event.getEntityLiving() instanceof EntityPlayer) {
            ...
            if (helmet != null && helmet.getItem() == ModArmor.helmetSilver) {
                armorPiecesWorn++;
            }
            if (chestplate != null && chestplate.getItem() == ModArmor.chestplateSilver) {
                armorPiecesWorn++;
            }
            if (leggings != null && leggings.getItem() == ModArmor.leggingsSilver) {
                armorPiecesWorn++;
            }
            if (boots != null && boots.getItem() == ModArmor.bootsSilver) {
                armorPiecesWorn++;
            }
