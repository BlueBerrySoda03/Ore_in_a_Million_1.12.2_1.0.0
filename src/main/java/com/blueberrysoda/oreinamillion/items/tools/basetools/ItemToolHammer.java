...
import com.blueberrysoda.oreinamillion.items.tools.customtools.ItemHammerCustom;
...
public class ItemToolHammer extends ItemHammerCustom {

    private final boolean addTooltip;

    public ItemToolHammer(String name, ToolMaterial material, CreativeTabs creativeTab, boolean addTooltip) {
        super(material);
