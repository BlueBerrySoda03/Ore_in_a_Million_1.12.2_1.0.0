...
public class ItemToolCoalHoe extends ItemHoe {
    ...
    public ItemToolCoalHoe(String name, ToolMaterial material, int burnTimeIn, boolean addTooltip) {
        super(material);
        this.burnTime = burnTimeIn;
        setRegistryName(name);
        setUnlocalizedName(OreInAMillion.MODID + "." + name);
        setCreativeTab(OreInAMillion.CREATIVE_TAB_TOOL);
        ItemToolCoalHoe.addTooltip = addTooltip;
    }
